...
class CSP(search.Problem):
    ...
    A CSP is specified by the following inputs:
        ...
        neighbors   : a dict of {var:[var2,...]} that for each variable lists
                      the other variables that participate in constraints.
        constraints : a function constraints(A, a, B, b) that returns 
                      True if A=a, B=b satisfies all constraints 
                      
    Constraints are usually specified as explicit pairs of allowable values
    but the formulation here is easier to express and more compact for
    most cases.

    However, the class also supports data structures and methods that help you
    solve CSPs by calling a search function on the CSP. Methods and slots are
    as follows, where the argument 'a' represents a dict of {var:val} entries:
    ...
    The following are just for debugging purposes:
        nassigns                variable : tracks the number of assignments made
    ...
    def __init__(self, variables, domains, neighbors, constraints):
        ...
        self.neighbors = neighbors or self.variables
    ...
    def nconflicts(self, var, val):
        """Return the number of conflicts var=val has with other variables."""
        # Subclasses may implement this more efficiently
        conflict = lambda var2: (var2 in self.assignment and \
    ...
    def display(self):
        ...
        print('CSP:', self, 'with assignment:', self.assignment)
